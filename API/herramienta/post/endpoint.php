...
<?php
	...
	switch ($function){
		...
		case 'upDateJefaLab':
			$herra = new Herramienta();
			echo $herra->upDateJefaLab($_POST['token'],$_POST['rol_usuario_id'],$_POST['id_herramienta'],$_POST['herramienta_tipo_id'],$_POST['fechaDeCompra'],$_POST['placas'],$_POST['condicion'],$_POST['observaciones']);
		break;
		case 'evaluateHerra':
			$herra = new Herramienta();
