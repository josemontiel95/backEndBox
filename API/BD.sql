...
ALTER TABLE cliente ADD COLUMN calle VARCHAR(40) NOT NULL;
ALTER TABLE cliente ADD COLUMN noExt VARCHAR(10) NOT NULL;
ALTER TABLE cliente ADD COLUMN noInt VARCHAR(10) NOT NULL;
ALTER TABLE cliente ADD COLUMN col VARCHAR(25) NOT NULL;
ALTER TABLE cliente ADD COLUMN municipio VARCHAR(50) NOT NULL;
ALTER TABLE cliente ADD COLUMN estado VARCHAR(30) NOT NULL;
