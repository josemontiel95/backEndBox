	...
	class InformeCilindros extends fpdf{
		...
		function putInfo(){
			...
			*/
			...
			//Caja de texto
			$this->SetX(50);
			$this->Cell(0,$tam_font_left - 3,'DUMMY','B',0,'C');
		...
		function putTables(){
			...
			if($this->GetY() < $endDown_table){
				...
				$this->cell($tam_ele,$tam_font_head - 2.5,$i,'L,B',2);
			}
			/*
					BYUENAS
			for ($i=0; $i < 8; $i++){
